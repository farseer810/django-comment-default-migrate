...
from django_comment_default_migrate.db_comments import migrate_app_models_comment_to_database
...
class DjangoCommentDefaultMigrationConfig(AppConfig):
    name = "django_comment_default_migrate"
